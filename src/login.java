...
public class login extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        employID_login.setFont(new java.awt.Font("微軟正黑體", 0, 14)); // NOI18N

        employPW_login.setFont(new java.awt.Font("微軟正黑體", 0, 14)); // NOI18N

        loginLabel03.setFont(new java.awt.Font("微軟正黑體", 0, 18)); // NOI18N
        loginLabel03.setText("修改密碼");

        employPwEdit_login.setFont(new java.awt.Font("微軟正黑體", 0, 14)); // NOI18N
        ...
        showResult_login.setText("message");
