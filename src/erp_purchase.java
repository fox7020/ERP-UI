 ...
 * @author 許哲浩
 */
public class erp_purchase extends JFrame {    
...
//        panel_firmName.setVisible(false);
...
//        setIconImage(Toolkit.getDefaultToolkit().getImage(getClass().getResource("/image/drink.png")));
        ...
        nowLayout.show(panel_dataInput, "adminP");
    ...
    private void initComponents() {
        ...
        table_firmData.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "進貨單號", "原料編號", "進貨日期", "採購人員", "廠商編號", "進貨數量", "進貨數量", "備註"
            }
        ) {
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new erp_purchase().setVisible(true);
            }
        });
    }
